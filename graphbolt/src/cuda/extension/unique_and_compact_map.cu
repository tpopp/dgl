...
// TODO(tpopp): Unsupported by rocm. Added in fork
...
// TODO(tpopp): added /std/ path to next line
...
// TODO(tpopp): removed /hip/->/cuda/ for next path
...
UniqueAndCompactBatchedHashMapBased(
  ...
  return AT_DISPATCH_INDEX_TYPES(
      scalar_type, "unique_and_compact", ([&] {
        ...
        hipcub::ArgIndexInputIterator index_it(indexes.data_ptr<int32_t>());
	...
	// This is essentially untested code in make_tabulate_output_iterator
	  ...
	  //     false, "TPOPP: tests/python/pytorch/graphbolt/impl/test_sampled_subgraph_impl.py reaches here?");
        ...
        CUB_CALL(
            ...
            offsets_ptr[2 * num_batches],
	    // TODO(tpopp): removed cuda namespace
            ::proclaim_return_type<bool>([] __device__(const auto& t) {
