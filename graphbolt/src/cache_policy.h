...
struct CacheKey {
  ...
  CacheKey(int64_t key, int64_t position)
    ...
    // TODO(tpopp): Removed assertion. Unknown why the size is important. Should pack bits.
...
#else
  // TODO(tpopp): rocm requires at least 4bytes for atomic_ref. int8_t doesn't work
